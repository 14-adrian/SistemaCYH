...
public class TableCustomReports {
    ...
    public static void apply(JScrollPane scroll, TableType type) {
        ...
        table.getTableHeader().setFont(new java.awt.Font("Segoe UI Semibold", 0, 14));
        ...
        table.getTableHeader().setBackground(Colores.cTblPed);
